...
const CONFIG = {
  ...
  authority: "https://login.microsoftonline.com/common", // "common" = personal + work/school accounts (matches "Any Entra ID Tenant + Personal Microsoft accounts")
...
const CALENDAR_PATTERN = /^(accepted|declined|tentative|tentatively accepted|canceled|cancelled|updated invitation|invitation):|meeting request|calendar invite/i;

function classifyCategory(msg, userDomain) {
  if (CALENDAR_PATTERN.test(msg.subject || "")) return "Calendar Invite";
