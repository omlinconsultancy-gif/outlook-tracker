...
/* --------------------------------------------------------------------
   ...
   -------------------------------------------------------------------- */
const CONFIG = {
  clientId: "560a4636-2ce3-433a-a0f6-148cc28489cf", // Application (client) ID from Azure Portal
  authority: "https://login.microsoftonline.com/common", // "common" = personal + work/school accounts
  redirectUri: "https://fanciful-semifreddo-e62374.netlify.app/", // must exactly match the Redirect URI registered in Azure
